+++
title = "Days 2-N: Waiting in Punta Arenas"
date = 2026-03-01
description = ""
tags = [ "thoughts"]
...
{{ dual_view(left="LLM expanded version (try it out and let me know what you think!)", right="My Raw Notes") }}
{% dv() %}
...
_Ed: Back to normal human writing_
...
<a href="https://blob.bask.day/cdn-cgi/image/format=auto/uploads/2026-03-03-113346-vbr360tx.jpg" target="_blank">
  <img alt="Park" src="https://blob.bask.day/cdn-cgi/image/width=800,format=auto/uploads/2026-03-03-113346-vbr360tx.jpg"
...
### Berries!
The name of the [berries](https://es.wikipedia.org/wiki/Gaultheria_mucronata) that we eventually found (and ate increasingly more of each day we went on hikes and found that it was compatible with our systems).
